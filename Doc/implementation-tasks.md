...
- [ ] 2.2.6 仮予約・本予約処理ロジック
- [ ] 2.2.7 予約承認・拒否処理Lambda実装
- [ ] 2.2.8 キャンセルポリシー実装（キャンセル料率計算）
- [ ] 2.2.9 DynamoDBストリームによる予約イベント処理

### 2.3 フロントエンド予約インターフェース
- [ ] 2.3.1 カレンダーコンポーネント実装（FullCalendar統合）
- [ ] 2.3.2 月間/週間/日間ビュー切替機能
- [ ] 2.3.3 空き状況の視覚的表示（空き/仮予約/本予約）
- [ ] 2.3.4 予約申請フォーム実装
